									...
									<div class="col-sm-9">
										...
										<div class="form-group-material">
											<input id="articleTitle" type="text" name="articleTitle"
												...
												for="articleTitle" class="label-material">文章标题</label>
										</div>
										<div class="form-group-material">
											<!-- 加载编辑器的容器 -->
											...
											<div class="form-group">
												 &nbsp;&nbsp;&nbsp;
													<input id="articleKeywords" type="text" placeholder="文章标签"
														...
														<input id="articleType" type="hidden" value="10"
														name="articleType"  class="mr-sm-3 form-control"> 
											</div>
											<div class="form-group">
						                          <select id ="articleMenuid" name="articleMenuid" placeholder="分类专栏" class="form-control mr-sm-3">
						                          </select>
											</div>
										</div>
										<div class="row">
											...
											<div class="form-group">
												...
												<textarea rows="3" cols="100" id="articleDescription"
													name="articleDescription" class="input-material" placeholder="文章描述"></textarea>
