			...
			<div class="right-menu list-inline no-margin-bottom">
				...
				<div class="list-inline-item dropdown">
					...
					<div aria-labelledby="navbarDropdownMenuLink1"
						...
						<a href="#"
							...
							<div class="profile">
								<img src="<%=request.getAttribute("basePath")%>static/darkadmin/img/avatar-3.jpg" alt="..." class="img-fluid">
							...
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="<%=request.getAttribute("basePath")%>static/darkadmin/img/avatar-2.jpg" alt="..." class="img-fluid">
							...
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="<%=request.getAttribute("basePath")%>static/darkadmin/img/avatar-1.jpg" alt="..." class="img-fluid">
							...
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="<%=request.getAttribute("basePath")%>static/darkadmin/img/avatar-5.jpg" alt="..." class="img-fluid">
				...
				<div class="list-inline-item dropdown">
					<a id="languages" rel="nofollow" data-target="#" href="#"
						...
						src="<%=request.getAttribute("basePath")%>static/darkadmin/img/flags/16/GB.png" alt="English"><span
					...
					<div aria-labelledby="languages" class="dropdown-menu">
						<a rel="nofollow" href="#" class="dropdown-item"> <img
							src="<%=request.getAttribute("basePath")%>static/darkadmin/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a
							rel="nofollow" href="#" class="dropdown-item"> <img
							src="<%=request.getAttribute("basePath")%>static/darkadmin/img/flags/16/FR.png" alt="English" class="mr-2"><span>French
						</span></a>
					</div>
				</div>
				<!-- Log out               -->
				<div class="list-inline-item logout">
					<a id="logout" href="<%=request.getAttribute("basePath")%>admin/logout" class="nav-link"> <span
